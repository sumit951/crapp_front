    ...
    { name: 'Created At', selector: row => format(row.createdAt, 'dd MMMM yyyy HH:mm '), sortable: true },
    {
      ...
      cell: row => (
        <div>
          ...
          <button className="text-blue-600 hover:underline text-sm mr-3" data-tooltip-id="my-tooltip" data-tooltip-content={'Edit Package'} onClick={() => handleOpenModal(row)}><Pencil size={20} /></button>
          
          <button className="text-orange-600 hover:underline text-sm mr-3" data-tooltip-id="my-tooltip" data-tooltip-content={'View Package Informartion'} onClick={() => handleViewpackageModal(row)}><Eye size={20} /></button>

          <button className="text-red-600 hover:underline text-sm" data-tooltip-id="my-tooltip" data-tooltip-content={'Delete Package'} onClick={() => handleDelete(row.id)}><Trash size={20} /></button>
        </div>
      ),
    },
  ];
  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-semibold text-[#092e46]">Packages</h1>
        ...
        <div className="fixed inset-0 bg-gray-500/50 bg-opacity-x flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
            ...
            <form onSubmit={handleFormSubmit} className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium">Sub Service</label>
                <select
                  name="subService"
                  className="w-full border border-gray-300 rounded px-3 py-2 text-sm"
              ...
              <div>
                <label className="block text-sm font-medium">No of Pages</label>
                <input
                  type="text"
                  name="numberOfPages"
              ...
              <div>
                <label className="block text-sm font-medium">Expected Delivery Date (Days)</label>
                <input
                  type="number"
                  min="1"
        ...
        <div className="fixed inset-0 bg-gray-500/50 bg-opacity-x flex items-center justify-center z-50">
            <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
                ...
                <div className="flex justify-between">
                    <label className="text-sm font-medium">Parent Service</label>
                ...
                <div className="flex justify-between">
                    <label className="text-sm font-medium">No of Pages</label>
                    <span>{editingpackage.numberOfPages}</span>
                </div>

                <div className="flex justify-between">
                    <label className="text-sm font-medium">Expected Delivery {`Day(s) : ${editingpackage.expectedDeliveryDate}`}</label>
                    <span>
                ...
                <div className="flex justify-between">
                    ...
                    <span>{editingpackage.amount}</span>
                </div>
